...
#Read UKB
rawUKB <- fread(paste0(dataDir,"/lung_cancer_summary_statistics/UKB/full_overall_maf00005_regenie.txt"))
rawUKB <- rawUKB %>% 
...
#Read ILCCO 
rawILCCO <- fread(paste0(dataDir,"/lung_cancer_summary_statistics/ILCCO/LC_Overall_hg19_chr",1,".txt")) 


for (i in 2:22) {
  temp <- fread(paste0(dataDir,"/lung_cancer_summary_statistics/ILCCO/LC_Overall_hg19_chr",i,".txt"))
