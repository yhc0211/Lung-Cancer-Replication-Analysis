# Analysis of real data - three-way scc replication studies
...
here::i_am("Lung/three_rep_scc.R")
...
fnameRoot <- paste0(outputDir, "/rep_three_scc_aID", aID)
...
testDat <- cleanUKB %>% select(Zlc_ilcco, Zukb,Zmvp)
