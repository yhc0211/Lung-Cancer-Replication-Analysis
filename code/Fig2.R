# Make Figure 2: Two-way Replication Analysis Simulation of the different mean and proportion of causal variants
...
ggsave(paste0(outputDir_Fig,"/Fig2.png"), plot = mergePlot, width = 13,
       height = 9)
