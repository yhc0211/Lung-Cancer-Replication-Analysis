# Make Figure 7: Three-way Replication Analysis and Meta Analysis Results
...
results_hg38 <- fread(here::here(outputDir, "hg38_overall.bed"),header=F)
...
# ggsave(paste0(outputDir_Fig,"/Fig6_1.png"), plot = manPlotFavor_AE, width = 6,
#         height = 6)
...
# ggsave(paste0(outputDir_Fig,"/Fig6_2.png"), plot = manPlotFavor_AC, width = 6,
#         height = 6)
...
results_hg38 <- fread(here::here(outputDir, "hg38_scc.bed"),header=F)
...
manPlotFavor_AE_SCC<- plotmanhattanFavor_AE(plotDatFavor,build = "hg19",colValues=wes_palette("FantasticFox1")[c(5,3,4)],shapeValues=c(16,17,18),
                                        ylimits=c(0, 10), legName="Epigenetics Score")

# ggsave(paste0(outputDir_Fig,"/Fig6_3.png"), plot = manPlotFavor_AE_SCC, width = 6,
#         height = 6)
...
manPlotFavor_AC_SCC<- plotmanhattanFavor_AC(plotDatFavor,build = "hg19",colValues=wes_palette("FantasticFox1")[c(5,3,4)], shapeValues=c(16,17,18),
                                        ylimits=c(0, 10), legName="Conservation Score")
...
ggsave(paste0(outputDir_Fig,"/Fig7.png"), plot = merge_plot, width = 12,
       height = 6)
